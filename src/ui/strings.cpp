...
constexpr const char* kEnglish[]{
    ...
    "This has nothing rolled to rate.",
    "You can probably run this but it has too many unrated modifiers.",
    "You can run this safely.",
    "You can run this safely but check the unrated modifiers.",
    "You should be able to run this.",
    "You should be able to run this but be careful.",
    "You will most probably die in here.",
