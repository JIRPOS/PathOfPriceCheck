...
GGG's public-API policy asks that unregistered clients offer a route to reach the maintainer, and
that URL is it. The same applies to the data bundle's own repository,
[PathOfPriceCheck-Data](https://github.com/JIRPOS/PathOfPriceCheck-Data), which has its own issue
tracker for anything about the data itself.
